...
bg_img_path = "paper.png"
font_path = "EBGaramond-Regular.ttf"
font_medium_path = "Cormorant-Medium.otf"
...
def draw_text(draw, name, title, phone, logo, tagline, address):
    ...
    # Draw text on the image centered at the specified positions
...
name = "test"
title = "test"
image_bytes = create(name, title, logo, tagline)
if image_bytes:
